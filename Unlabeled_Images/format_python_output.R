...
#' 
#' @description format results from unlabeled images run on the CameraTrapDetectoR model in Python
#' 
#' @param df dataframe of predictions; form of .csv file generated from evalCTD.py script
#' 
#' @returns dataframe in the same format as though it was run through the R package
#' 
#' @import dplyr
#' 
#' @export
#' 
format_python_output <- function(df){
