#' Format MD predictions
#' 
#' @description Open Megadetector results, format, convert to data frame
#' 
#' @param json_path path to json file
#' @param score_threshold confidence score threshold; flag any predictions below this threshold
#' 
#' @returns data frame
#' 
#' @import rjson
...
#' 
#' @export
format_md_preds <- function(json_path, score_threshold){
  ...
  # flag detections below score threshold
  md_df <- md_df %>%
    mutate(flag = ifelse(conf < score_threshold, paste(flag, "conf_flag", sep = ", "), flag))
